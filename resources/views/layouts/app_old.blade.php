...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('custom-libraries/chart.js/Chart.min.js') }}"></script>
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                            ...
                            <li class="nav-item dropdown">
                                <a id="orderDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
