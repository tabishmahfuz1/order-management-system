...
<tr class="item_row" data-row-num="{{ $row_num }}" data-so-item-id="{{ $item['id'] }}">
  ...
  <td>
    <input type="number" name="order[items][{{$row_num}}][item_price]" value="{{$item['item_price']}}" step=".01" readonly class="form-control editable_input item_price_input calculation_input"/>
  </td>
  <td>
    <input type="number" name="order[items][{{$row_num}}][item_disc_per]" value="{{$item['item_disc_per']}}" step=".01" readonly class="form-control editable_input item_disc_per_input calculation_input"/>
  </td>
  <td>
    <input type="number" name="order[items][{{$row_num}}][item_disc_amt]" value="{{$item['item_disc_amt']}}"  step=".01" readonly class="form-control item_disc_amt_input calculation_input"/>
  </td>
  <td>
  ...
  <td>
    <input type="number" name="order[items][{{$row_num}}][tax_rate]" value="{{$item['tax_rate']}}" step=".01" readonly class="form-control editable_input tax_rate_input calculation_input"/>
  </td>
  <td>
  ...
  <td>
    <input type="number" name="order[items][{{$row_num}}][item_qty]" value="{{$item['item_qty']}}" readonly class="form-control editable_input item_qty_input calculation_input"/>
  </td>
  <td>
